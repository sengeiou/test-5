...
static err_info err_list[] = {
	...
	ERR_ENTRY("VC_ELM_ERROR_INVALID_LANGUAGE", TIZEN_ERROR_VOICE_CONTROL | 0x022, "Invalid language"),
	...
	ERR_ENTRY("DCM_ERROR_SOCKET", TIZEN_ERROR_DEVICE_CERTIFICATE_MANAGER | 0x01, "Socket error between client and Device Certificate Manager"),
	ERR_ENTRY("STC_ERROR_OPERATION_FAILED", TIZEN_ERROR_STC | 0x01, "Operation failed"),
	ERR_ENTRY("STC_ERROR_NOT_INITIALIZED", TIZEN_ERROR_STC | 0x02, "Not initialized"),
	ERR_ENTRY("STC_ERROR_ALREADY_INITIALIZED", TIZEN_ERROR_STC | 0x03, "Already initialized"),
	ERR_ENTRY("STC_ERROR_IN_PROGRESS", TIZEN_ERROR_STC | 0x04, "In progress"),
	...
	ERR_ENTRY("CONNECTION_ERROR_ALREADY_INITIALIZED", TIZEN_ERROR_CONNECTION | 0x0409, "Already initialized"),
	ERR_ENTRY("CONNECTION_ERROR_NOT_INITIALIZED", TIZEN_ERROR_CONNECTION | 0x040A, "Not initialized"),
	ERR_ENTRY("STICKER_ERROR_OPERATION_FAILED", TIZEN_ERROR_STICKER | 0x0001, "Operation failed"),
	...
	ERR_ENTRY("SHORTCUT_ERROR_NOT_EXIST", TIZEN_ERROR_SHORTCUT | 0x0008, "Not exist shortcut"),
	...
	ERR_ENTRY("ASP_ERROR_NOT_INITIALIZED", TIZEN_ERROR_ASP | 0x01, "Not initialized"),
	ERR_ENTRY("ASP_ERROR_ALREADY_INITIALIZED", TIZEN_ERROR_ASP | 0x02, "Already initialized"),
	ERR_ENTRY("ASP_ERROR_COMMUNICATION_FAILED", TIZEN_ERROR_ASP | 0x03, "I/O error"),
	ERR_ENTRY("ASP_ERROR_OPERATION_FAILED", TIZEN_ERROR_ASP | 0x04, "Operation failed"),
	ERR_ENTRY("ASP_ERROR_IN_PROGRESS", TIZEN_ERROR_ASP | 0x05, "In progress"),
	ERR_ENTRY("ASP_ERROR_SERVICE_NOT_FOUND", TIZEN_ERROR_ASP | 0x06, "Service not found"),
	ERR_ENTRY("ASP_ERROR_SESSION_NOT_FOUND", TIZEN_ERROR_ASP | 0x07, "Session not found"),
	ERR_ENTRY("ASP_ERROR_NETWORK_ROLE_REJECTED", TIZEN_ERROR_ASP | 0x08, "Requested network role rejected"),
	...
	ERR_ENTRY("TZSH_ERROR_NO_SERVICE", TIZEN_ERROR_TZSH | 0x01, "Service does not exist"),
	...
	ERR_ENTRY("MEDIACODEC_ERROR_RESOURCE_CONFLICT", TIZEN_ERROR_MEDIACODEC | 0x0f, "Interrupted by a resource conflict"),
	ERR_ENTRY("WEBRTC_ERROR_INVALID_STATE", TIZEN_ERROR_MEDIA_WEBRTC | 0x01, "Invalid state"),
	ERR_ENTRY("WEBRTC_ERROR_CONNECTION_FAILED", TIZEN_ERROR_MEDIA_WEBRTC | 0x02, "Connection failed"),
	...
	ERR_ENTRY("TTS_ERROR_SCREEN_READER_OFF", TIZEN_ERROR_TTS | 0x08, "Screen reader is off"),
	ERR_ENTRY("GENERIC_TEXT_CLASSIFIER_ERROR_ALREADY_DONE", TIZEN_ERROR_GENERIC_TEXT_CLASSIFIER | 0x01, "Operation already done"),
	ERR_ENTRY("GENERIC_TEXT_CLASSIFIER_ERROR_HANDLE_NOT_CREATED", TIZEN_ERROR_GENERIC_TEXT_CLASSIFIER | 0x02, "Handle not created"),
	ERR_ENTRY("GENERIC_TEXT_CLASSIFIER_ERROR_HANDLE_NOT_VALID", TIZEN_ERROR_GENERIC_TEXT_CLASSIFIER | 0x03, "Wrong handle passed"),
	ERR_ENTRY("GENERIC_TEXT_CLASSIFIER_ERROR_INITIALIZATION_NOT_DONE", TIZEN_ERROR_GENERIC_TEXT_CLASSIFIER | 0x04, "Module initialization not done"),
	ERR_ENTRY("GENERIC_TEXT_CLASSIFIER_ERROR_INTERNAL", TIZEN_ERROR_GENERIC_TEXT_CLASSIFIER | 0x05, "Internal error for generic use"),
	...
	ERR_ENTRY("VC_ERROR_SERVICE_RESET", TIZEN_ERROR_VOICE_CONTROL | 0x018, "Service reset"),
	ERR_ENTRY("VC_ERROR_IN_PROGRESS_TO_READY", TIZEN_ERROR_VOICE_CONTROL | 0x019, "In progress to ready"),
	...
	ERR_ENTRY("UA_ERROR_OPERATION_FAILED", TIZEN_ERROR_USER_AWARENESS | 0x04, "Operation Failed"),
	ERR_ENTRY("UA_ERROR_NOT_READY", TIZEN_ERROR_USER_AWARENESS | 0x05, "Resource not ready"),
	ERR_ENTRY("UA_ERROR_NOT_ENABLED", TIZEN_ERROR_USER_AWARENESS | 0x06, "Not enabled"),
	ERR_ENTRY("UA_ERROR_NOT_FOUND", TIZEN_ERROR_USER_AWARENESS | 0x07, "Not found"),
	ERR_ENTRY("UA_ERROR_ALREADY_REGISTERED", TIZEN_ERROR_USER_AWARENESS | 0x08, "Already registered"),
	ERR_ENTRY("UA_ERROR_DB_FAILED", TIZEN_ERROR_USER_AWARENESS | 0x09, "DB operation failed"),
	ERR_ENTRY("UA_ERROR_NOT_REGISTERED", TIZEN_ERROR_USER_AWARENESS | 0x0a, "Not registered"),
	...
	ERR_ENTRY("CSR_ERROR_USER_RESPONSE_FAILED", TIZEN_ERROR_CSR | 0x07, "Getting user response is failed"),
	ERR_ENTRY("CSR_ERROR_FILE_DO_NOT_EXIST", TIZEN_ERROR_CSR | 0x08, "File not exist"),
	ERR_ENTRY("CSR_ERROR_FILE_CHANGED", TIZEN_ERROR_CSR | 0x09, "File changed after detection"),
	ERR_ENTRY("CSR_ERROR_FILE_SYSTEM", TIZEN_ERROR_CSR | 0x10, "File type is invalid"),
	...
	ERR_ENTRY("PLAYER_ERROR_NOT_SUPPORTED_AUDIO_CODEC", TIZEN_ERROR_PLAYER | 0x2e, "Not supported audio codec but video can be played"),
	...
	ERR_ENTRY("SOFTAP_ERROR_OPERATION_FAILED", TIZEN_ERROR_SOFTAP | 0x01, "Operation failed"),
	ERR_ENTRY("SOFTAP_ERROR_ALREADY_ENABLED", TIZEN_ERROR_SOFTAP | 0x02, "Already enabled"),
	...
	ERR_ENTRY("I18N_ERROR_BAD_VARIABLE_DEFINITION", TIZEN_ERROR_UTILITY_ICU | 0x1000, "Missing \'$\' or duplicate variable name"),
	ERR_ENTRY("I18N_ERROR_MALFORMED_RULE", TIZEN_ERROR_UTILITY_ICU | 0x1001, "Elements of a rule are misplaced"),
	ERR_ENTRY("I18N_ERROR_MALFORMED_UNICODE_ESCAPE", TIZEN_ERROR_UTILITY_ICU | 0x1002, "A Unicode escape pattern is invalid"),
	ERR_ENTRY("I18N_ERROR_MALFORMED_VARIABLE_DEFINITION", TIZEN_ERROR_UTILITY_ICU | 0x1003, "A variable definition is invalid"),
	ERR_ENTRY("I18N_ERROR_MALFORMED_VARIABLE_REFERENCE", TIZEN_ERROR_UTILITY_ICU | 0x1004, "A variable reference is invalid"),
	ERR_ENTRY("I18N_ERROR_MISPLACED_ANCHOR_START", TIZEN_ERROR_UTILITY_ICU | 0x1005, "A start anchor appears at an illegal position"),
	ERR_ENTRY("I18N_ERROR_MISPLACED_CURSOR_OFFSET", TIZEN_ERROR_UTILITY_ICU | 0x1006, "A cursor offset occurs at an illegal position"),
	ERR_ENTRY("I18N_ERROR_MISPLACED_QUANTIFIER", TIZEN_ERROR_UTILITY_ICU | 0x1007, "A quantifier appears after a segment close delimiter"),
	ERR_ENTRY("I18N_ERROR_MISSING_OPERATOR", TIZEN_ERROR_UTILITY_ICU | 0x1008, "A rule contains no operator"),
	ERR_ENTRY("I18N_ERROR_MULTIPLE_ANTE_CONTEXTS", TIZEN_ERROR_UTILITY_ICU | 0x1009, "More than one ante context"),
	ERR_ENTRY("I18N_ERROR_MULTIPLE_CURSORS", TIZEN_ERROR_UTILITY_ICU | 0x100A, "More than one cursor"),
	ERR_ENTRY("I18N_ERROR_MULTIPLE_POST_CONTEXTS", TIZEN_ERROR_UTILITY_ICU | 0x100B, "More than one post context"),
	ERR_ENTRY("I18N_ERROR_TRAILING_BACKSLASH", TIZEN_ERROR_UTILITY_ICU | 0x100C, "A dangling backslash"),
	ERR_ENTRY("I18N_ERROR_UNDEFINED_SEGMENT_REFERENCE", TIZEN_ERROR_UTILITY_ICU | 0x100D, "A segment reference does not correspond to a defined segment"),
	ERR_ENTRY("I18N_ERROR_UNDEFINED_VARIABLE", TIZEN_ERROR_UTILITY_ICU | 0x100E, "A variable reference does not correspond to a defined variable"),
	ERR_ENTRY("I18N_ERROR_UNQUOTED_SPECIAL", TIZEN_ERROR_UTILITY_ICU | 0x100F, "A special character was not quoted or escaped"),
	ERR_ENTRY("I18N_ERROR_UNTERMINATED_QUOTE", TIZEN_ERROR_UTILITY_ICU | 0x1010, "A closing single quote is missing"),
	ERR_ENTRY("I18N_ERROR_RULE_MASK", TIZEN_ERROR_UTILITY_ICU | 0x1011, "A rule is hidden by an earlier more general rule"),
	ERR_ENTRY("I18N_ERROR_MISPLACED_COMPOUND_FILTER", TIZEN_ERROR_UTILITY_ICU | 0x1012, "A compound filter is in an invalid location"),
	ERR_ENTRY("I18N_ERROR_MULTIPLE_COMPOUND_FILTERS", TIZEN_ERROR_UTILITY_ICU | 0x1013, "More than one compound filter"),
	ERR_ENTRY("I18N_ERROR_INVALID_RBT_SYNTAX", TIZEN_ERROR_UTILITY_ICU | 0x1014, "More than one compound filter"),
	ERR_ENTRY("I18N_ERROR_MALFORMED_PRAGMA", TIZEN_ERROR_UTILITY_ICU | 0x1015, "A \'use\' pragma is invalid"),
	ERR_ENTRY("I18N_ERROR_UNCLOSED_SEGMENT", TIZEN_ERROR_UTILITY_ICU | 0x1016, "A closing \')\' is missing"),
	ERR_ENTRY("I18N_ERROR_VARIABLE_RANGE_EXHAUSTED", TIZEN_ERROR_UTILITY_ICU | 0x1017, "Too many stand-ins generated for the given variable range"),
	ERR_ENTRY("I18N_ERROR_VARIABLE_RANGE_OVERLAP", TIZEN_ERROR_UTILITY_ICU | 0x1018, "The variable range overlaps characters used in rules"),
	ERR_ENTRY("I18N_ERROR_ILLEGAL_CHARACTER", TIZEN_ERROR_UTILITY_ICU | 0x1019, "A special character is outside its allowed context"),
	ERR_ENTRY("I18N_ERROR_INTERNAL_TRANSLITERATOR", TIZEN_ERROR_UTILITY_ICU | 0x101A, "Internal transliterator system error"),
	ERR_ENTRY("I18N_ERROR_INVALID_ID", TIZEN_ERROR_UTILITY_ICU | 0x101B, "A \"::id\" rule specifies an unknown transliterator"),
	ERR_ENTRY("I18N_ERROR_INVALID_FUNCTION", TIZEN_ERROR_UTILITY_ICU | 0x101C, "A \"&fn()\" rule specifies an unknown transliterator"),
	ERR_ENTRY("I18N_ERROR_UNEXPECTED_TOKEN", TIZEN_ERROR_UTILITY_ICU | 0x2000, "Syntax error in format pattern"),
	ERR_ENTRY("I18N_ERROR_MULTIPLE_DECIMAL_SEPARATORS", TIZEN_ERROR_UTILITY_ICU | 0x2001, "More than one decimal separator in number pattern"),
	ERR_ENTRY("I18N_ERROR_MULTIPLE_EXPONENTIAL_SYMBOLS", TIZEN_ERROR_UTILITY_ICU | 0x2002, "More than one exponent symbol in number pattern"),
	ERR_ENTRY("I18N_ERROR_MALFORMED_EXPONENTIAL_PATTERN", TIZEN_ERROR_UTILITY_ICU | 0x2003, "Grouping symbol in exponent pattern"),
	ERR_ENTRY("I18N_ERROR_MULTIPLE_PERCENT_SYMBOLS", TIZEN_ERROR_UTILITY_ICU | 0x2004, "More than one percent symbol in number pattern"),
	ERR_ENTRY("I18N_ERROR_MULTIPLE_PERMILL_SYMBOLS", TIZEN_ERROR_UTILITY_ICU | 0x2005, "More than one permill symbol in number pattern"),
	ERR_ENTRY("I18N_ERROR_MULTIPLE_PAD_SPECIFIERS", TIZEN_ERROR_UTILITY_ICU | 0x2006, "More than one pad symbol in number pattern"),
	ERR_ENTRY("I18N_ERROR_PATTERN_SYNTAX", TIZEN_ERROR_UTILITY_ICU | 0x2007, "Syntax error in format pattern"),
	ERR_ENTRY("I18N_ERROR_ILLEGAL_PAD_POSITION", TIZEN_ERROR_UTILITY_ICU | 0x2008, "Pad symbol misplaced in number pattern"),
	ERR_ENTRY("I18N_ERROR_UNMATCHED_BRACES", TIZEN_ERROR_UTILITY_ICU | 0x2009, "Braces do not match in message pattern"),
	ERR_ENTRY("I18N_ERROR_ARGUMENT_TYPE_MISMATCH", TIZEN_ERROR_UTILITY_ICU | 0x200A, "Argument name and argument index mismatch in format functions"),
	ERR_ENTRY("I18N_ERROR_DUPLICATE_KEYWORD", TIZEN_ERROR_UTILITY_ICU | 0x200B, "Duplicate keyword in PluralFormat"),
	ERR_ENTRY("I18N_ERROR_UNDEFINED_KEYWORD", TIZEN_ERROR_UTILITY_ICU | 0x200C, "Undefined Plural keyword"),
	ERR_ENTRY("I18N_ERROR_DEFAULT_KEYWORD_MISSING", TIZEN_ERROR_UTILITY_ICU | 0x200D, "Missing DEFAULT rule in plural rules"),
	ERR_ENTRY("I18N_ERROR_DECIMAL_NUMBER_SYNTAX", TIZEN_ERROR_UTILITY_ICU | 0x200E, "Decimal number syntax error"),
	ERR_ENTRY("I18N_ERROR_INEXACT_FORMAT", TIZEN_ERROR_UTILITY_ICU | 0x200F, "Cannot format a number exactly and rounding mode is unnecessary"),
	ERR_ENTRY("I18N_ERROR_UBRK_INTERNAL", TIZEN_ERROR_UTILITY_ICU | 0x3001, "An internal ICU error (bug) was detected"),
	ERR_ENTRY("I18N_ERROR_UBRK_HEX_DIGITS_EXPECTED", TIZEN_ERROR_UTILITY_ICU | 0x3002, "Hex digits expected as part of a escaped char in a rule"),
	ERR_ENTRY("I18N_ERROR_UBRK_SEMICOLON_EXPECTED", TIZEN_ERROR_UTILITY_ICU | 0x3003, "Missing \';\' at the end of a RBBI rule"),
	ERR_ENTRY("I18N_ERROR_UBRK_RULE_SYNTAX", TIZEN_ERROR_UTILITY_ICU | 0x3004, "Syntax error in RBBI rule"),
	ERR_ENTRY("I18N_ERROR_UBRK_UNCLOSED_SET", TIZEN_ERROR_UTILITY_ICU | 0x3004, "UnicodeSet witing an RBBI rule missing a closing \']\'"),
	ERR_ENTRY("I18N_ERROR_UBRK_ASSIGN_ERROR", TIZEN_ERROR_UTILITY_ICU | 0x3005, "Syntax error in RBBI rule assignment statement"),
	ERR_ENTRY("I18N_ERROR_UBRK_VARIABLE_REDEFINITION", TIZEN_ERROR_UTILITY_ICU | 0x3006, "RBBI rule $Variable redefined"),
	ERR_ENTRY("I18N_ERROR_UBRK_MISMATCHED_PAREN", TIZEN_ERROR_UTILITY_ICU | 0x3007, "Mis-matched parentheses in an RBBI rule"),
	ERR_ENTRY("I18N_ERROR_UBRK_NEW_LINE_IN_QUOTED_STRING", TIZEN_ERROR_UTILITY_ICU | 0x3008, "Missing closing quote in an RBBI rule"),
	ERR_ENTRY("I18N_ERROR_UBRK_UNDEFINED_VARIABLE", TIZEN_ERROR_UTILITY_ICU | 0x3009, "Use of an undefined $Variable in an RBBI rule"),
	ERR_ENTRY("I18N_ERROR_UBRK_INIT", TIZEN_ERROR_UTILITY_ICU | 0x300A, "Initialization failure. Probable missing ICU Data"),
	ERR_ENTRY("I18N_ERROR_UBRK_RULE_EMPTY_SET", TIZEN_ERROR_UTILITY_ICU | 0x300B, "Rule contains an empty Unicode Set"),
	ERR_ENTRY("I18N_ERROR_UBRK_UNRECOGNIZED_OPTION", TIZEN_ERROR_UTILITY_ICU | 0x300C, "Option in RBBI rules not recognized"),
	ERR_ENTRY("I18N_ERROR_UBRK_MALFORMED_RULE_TAG", TIZEN_ERROR_UTILITY_ICU | 0x300D, "The {nnn} tag on a rule is malformed"),
	...
	ERR_ENTRY("WIFI_MANAGER_ERROR_OPERATION_FAILED", TIZEN_ERROR_WIFI_MANAGER | 0x01, "Operation failed"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_NO_CONNECTION", TIZEN_ERROR_WIFI_MANAGER | 0x02, "There is no connected AP"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_ALREADY_EXISTS", TIZEN_ERROR_WIFI_MANAGER | 0x03, "Already exists"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_OPERATION_ABORTED", TIZEN_ERROR_WIFI_MANAGER | 0x04, "Operation is aborted "),
	ERR_ENTRY("WIFI_MANAGER_ERROR_DHCP_FAILED", TIZEN_ERROR_WIFI_MANAGER | 0x05, "DHCP failed"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_INVALID_KEY", TIZEN_ERROR_WIFI_MANAGER | 0x06, "Invalid key"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_NO_REPLY", TIZEN_ERROR_WIFI_MANAGER | 0x07, "No reply"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_SECURITY_RESTRICTED", TIZEN_ERROR_WIFI_MANAGER | 0x08, "Restricted by security system policy"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_ALREADY_INITIALIZED", TIZEN_ERROR_WIFI_MANAGER | 0x09, "Already initialized"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_OUT_OF_RANGE", TIZEN_ERROR_WIFI_MANAGER | 0x0A, "Out of range"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_CONNECT_FAILED", TIZEN_ERROR_WIFI_MANAGER | 0x0B, "Connect failed"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_LOGIN_FAILED", TIZEN_ERROR_WIFI_MANAGER | 0x0C, "Login failed"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_AUTHENTICATION_FAILED", TIZEN_ERROR_WIFI_MANAGER | 0x0D, "Authentication failed"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_PIN_MISSING", TIZEN_ERROR_WIFI_MANAGER | 0x0E, "PIN missing"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_WPS_OVERLAP", TIZEN_ERROR_WIFI_MANAGER | 0x0F, "WPS overlap"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_WPS_TIMEOUT", TIZEN_ERROR_WIFI_MANAGER | 0x10, "WPS timeout"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_WPS_WEP_PROHIBITED", TIZEN_ERROR_WIFI_MANAGER | 0x11, "WPS WEP prohibited"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_OFFLINE", TIZEN_ERROR_WIFI_MANAGER | 0x12, "Connection Offline"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_INVALID_GATEWAY", TIZEN_ERROR_WIFI_MANAGER | 0x13, "Invalid Gateway"),
	ERR_ENTRY("WIFI_MANAGER_ERROR_NOT_INITIALIZED", TIZEN_ERROR_WIFI_MANAGER | 0x14, "Not initialized"),
	...
	ERR_ENTRY("CION_ERROR_OPERATION_FAILED", TIZEN_ERROR_CION | 0x01, "Operation failed"),
	...
	ERR_ENTRY("BUNDLE_ERROR_ARRAY_INDEX_OUT_OF_BOUNDS", TIZEN_ERROR_BUNDLE | 0x02, "The index is out of bounds of the array"),
	...
	ERR_ENTRY("MA_ERROR_OPERATION_FAILED", TIZEN_ERROR_MULTI_ASSISTANT | 0x014, "Operation failed"),
	ERR_ENTRY("MA_ERROR_SERVICE_RESET", TIZEN_ERROR_MULTI_ASSISTANT | 0x015, "Service reset"),
	ERR_ENTRY("MA_ERROR_NOT_SUPPORTED_FEATURE", TIZEN_ERROR_MULTI_ASSISTANT | 0x016, "Feature not supported"),
	...
	ERR_ENTRY("METADATA_EDITOR_ERROR_METADATA_UPDATE_NOT_POSSIBLE", TIZEN_ERROR_METADATA_EDITOR | 0x02, "Update not possible"),
	...
	ERR_ENTRY("PRVINFO_ERROR_NO_MATCHING_PRIVILEGE", TIZEN_ERROR_PRIVILEGE_INFORMATION | 0x01, "Unknown privilege "),
	...
	ERR_ENTRY("AUTOFILL_ERROR_AUTHENTICATION_FAILED", TIZEN_ERROR_AUTOFILL | 0x0003, "Authentication failed"),
	ERR_ENTRY("AUTOFILL_ERROR_COMMIT_FAILED", TIZEN_ERROR_AUTOFILL | 0x0004, "These values can not be saved"),
	ERR_ENTRY("AUTOFILL_ERROR_FILL_RESPONSE_FAILED", TIZEN_ERROR_AUTOFILL | 0x0005, "Failed to create required values"),
	ERR_ENTRY("AUTOFILL_ERROR_SERVICE_NOT_CONNECTED", TIZEN_ERROR_AUTOFILL | 0x0006, "Unable to connect to Autofill Service"),
	ERR_ENTRY("AUTOFILL_ERROR_SERVICE_NOT_ALLOWED", TIZEN_ERROR_AUTOFILL | 0x0007, "Autofill Service is not allowed"),
	ERR_ENTRY("AUTOFILL_ERROR_SERVICE_NOT_ACTIVATED", TIZEN_ERROR_AUTOFILL | 0x0008, "Autofill Service is not activated"),
	ERR_ENTRY("AUTOFILL_ERROR_SAVED_VALUES_NOT_FOUND", TIZEN_ERROR_AUTOFILL | 0x0009, "Could not find saved values"),
	...
	ERR_ENTRY("BT_ERROR_AUTHORIZATION_REJECTED", TIZEN_ERROR_BLUETOOTH | 0x010E, "Authorization rejected"),
