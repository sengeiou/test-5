...
char* YacaGetError(int nRet)
{
	...
	switch ( nRet )
	{
		case YACA_ERROR_NONE:					szErrorVal = "YACA_ERROR_NONE";						break;
		case YACA_ERROR_INVALID_PARAMETER:			szErrorVal = "YACA_ERROR_INVALID_PARAMETER";			break;
		case YACA_ERROR_OUT_OF_MEMORY:		szErrorVal = "YACA_ERROR_OUT_OF_MEMORY";		break;
		case YACA_ERROR_INTERNAL:		szErrorVal = "YACA_ERROR_INTERNAL";		break;
		case YACA_ERROR_DATA_MISMATCH:		szErrorVal = "YACA_ERROR_DATA_MISMATCH";		break;
		case YACA_ERROR_INVALID_PASSWORD:		szErrorVal = "YACA_ERROR_INVALID_PASSWORD";			break;
