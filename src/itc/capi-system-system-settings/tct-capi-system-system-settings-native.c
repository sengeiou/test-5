...
#include "tct-capi-system-system-settings-native_mobile.h"
#endif  //MOBILE	//End MOBILE

#ifdef WEARABLE	//Starts WEARABLE
#include "tct-capi-system-system-settings-native_wearable.h"
...
#include "tct-capi-system-system-settings-native_tizeniot.h"
