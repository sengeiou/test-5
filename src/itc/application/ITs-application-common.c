...
/**
* @function             AppControlUriGetError
* @description          Maps error enums to string values
* @parameter            nRet : error code returned
* @return                       error string
*/
char* AppControlUriGetError(int nRet)
{
        ...
        switch ( nRet )
        {
        case APP_CONTROL_URI_ERROR_NONE:                                    szErrorVal = "APP_CONTROL_URI_ERROR_NONE";break;
        case APP_CONTROL_URI_ERROR_IO_ERROR:               szErrorVal = "APP_CONTROL_URI_ERROR_IO_ERROR";break;
        case APP_CONTROL_URI_ERROR_OUT_OF_MEMORY:                   szErrorVal = "APP_CONTROL_URI_ERROR_OUT_OF_MEMORY";break;
        case APP_CONTROL_URI_ERROR_INVALID_PARAMETER:                   szErrorVal = "APP_CONTROL_URI_ERROR_INVALID_PARAMETER";break;
        default:                                                                                szErrorVal = "Undefined Error";break;
        }
        return szErrorVal;
}
