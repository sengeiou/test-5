...
#include "tct-voice-control-elm-native_mobile.h"
#endif  //MOBILE	//End MOBILE

#ifdef WEARABLE	//Starts WEARABLE
#include "tct-voice-control-elm-native_wearable.h"
#endif  //WEARABLE	//End WEARABLE

#ifdef TV	//Starts TV
#include "tct-voice-control-elm-native_tv.h"
#endif  //TV	//End TV

#ifdef TIZENIOT	//Starts TIZENIOT
#include "tct-voice-control-elm-native_tizeniot.h"
...
int run_testcases()
{
    ...
    for (i = 0; tc_array[i].name; i++) {
	    ...
	    dlog_print(DLOG_INFO, "NativeTCT", "%s : Cleanup end", func_name);
            ...
            {
		free(func_name);
		printf("Unable to open tcresult file.\n");
	        return 2;
	    }
