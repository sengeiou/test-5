...
testcase tc_array[] = {
	{
		"utc_job_info_create_p",
		utc_job_info_create_p,
		NULL,
		utc_job_info_create_p_cleanup
	},
	{
		"utc_job_info_create_n",
		utc_job_info_create_n,
		NULL,
		NULL
	},
	{
		"utc_job_info_destroy_p",
		utc_job_info_destroy_p,
		utc_job_info_destroy_p_startup,
		utc_job_info_destroy_p_cleanup
	},
	{
		"utc_job_info_destroy_n",
		utc_job_info_destroy_n,
		NULL,
		NULL
	},
	{
		"utc_job_info_set_periodic_p",
		utc_job_info_set_periodic_p,
		utc_job_info_set_periodic_p_startup,
		utc_job_info_set_periodic_p_cleanup
	},
	{
		"utc_job_info_set_periodic_n",
		utc_job_info_set_periodic_n,
		NULL,
		NULL
	},
	{
		"utc_job_info_set_persistent_p",
		utc_job_info_set_persistent_p,
		utc_job_info_set_persistent_p_startup,
		utc_job_info_set_persistent_p_cleanup
	},
	{
		"utc_job_info_set_persistent_n",
		utc_job_info_set_persistent_n,
		NULL,
		NULL
	},
	{
		"utc_job_info_set_once_p",
		utc_job_info_set_once_p,
		utc_job_info_set_once_p_startup,
		utc_job_info_set_once_p_cleanup
	},
	{
		"utc_job_info_set_once_n",
		utc_job_info_set_once_n,
		NULL,
		NULL
	},
	{
		"utc_job_info_set_requirement_timeout_p",
		utc_job_info_set_requirement_timeout_p,
		utc_job_info_set_requirement_timeout_p_startup,
		utc_job_info_set_requirement_timeout_p_cleanup
	},
	{
		"utc_job_info_set_requirement_timeout_n",
		utc_job_info_set_requirement_timeout_n,
		NULL,
		NULL
	},
	{
		"utc_job_info_set_requires_battery_not_low_p",
		utc_job_info_set_requires_battery_not_low_p,
		utc_job_info_set_requires_battery_not_low_p_startup,
		utc_job_info_set_requires_battery_not_low_p_cleanup
	},
	{
		"utc_job_info_set_requires_battery_not_low_n1",
		utc_job_info_set_requires_battery_not_low_n1,
		NULL,
		NULL
	},
	{
		"utc_job_info_set_requires_battery_not_low_n2",
		utc_job_info_set_requires_battery_not_low_n2,
		utc_job_info_set_requires_battery_not_low_n2_startup,
		utc_job_info_set_requires_battery_not_low_n2_cleanup
	},
	{
		"utc_job_info_set_requires_charging_p",
		utc_job_info_set_requires_charging_p,
		utc_job_info_set_requires_charging_p_startup,
		utc_job_info_set_requires_charging_p_cleanup
	},
	{
		"utc_job_info_set_requires_charging_n1",
		utc_job_info_set_requires_charging_n1,
		NULL,
		NULL
	},
	{
		"utc_job_info_set_requires_charging_n2",
		utc_job_info_set_requires_charging_n2,
		utc_job_info_set_requires_charging_n2_startup,
		utc_job_info_set_requires_charging_n2_cleanup
	},
	{
		"utc_job_info_set_requires_wifi_connection_p",
		utc_job_info_set_requires_wifi_connection_p,
		utc_job_info_set_requires_wifi_connection_p_startup,
		utc_job_info_set_requires_wifi_connection_p_cleanup
	},
	{
		"utc_job_info_set_requires_wifi_connection_n1",
		utc_job_info_set_requires_wifi_connection_n1,
		NULL,
		NULL
	},
	{
		"utc_job_info_set_requires_wifi_connection_n2",
		utc_job_info_set_requires_wifi_connection_n2,
		utc_job_info_set_requires_wifi_connection_n2_startup,
		utc_job_info_set_requires_wifi_connection_n2_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p1",
		utc_job_info_add_trigger_event_p1,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p2",
		utc_job_info_add_trigger_event_p2,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p3",
		utc_job_info_add_trigger_event_p3,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p4",
		utc_job_info_add_trigger_event_p4,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p5",
		utc_job_info_add_trigger_event_p5,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p6",
		utc_job_info_add_trigger_event_p6,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p7",
		utc_job_info_add_trigger_event_p7,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p8",
		utc_job_info_add_trigger_event_p8,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p9",
		utc_job_info_add_trigger_event_p9,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p10",
		utc_job_info_add_trigger_event_p1,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p11",
		utc_job_info_add_trigger_event_p11,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p12",
		utc_job_info_add_trigger_event_p12,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p13",
		utc_job_info_add_trigger_event_p13,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p14",
		utc_job_info_add_trigger_event_p14,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p15",
		utc_job_info_add_trigger_event_p15,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p16",
		utc_job_info_add_trigger_event_p16,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p17",
		utc_job_info_add_trigger_event_p17,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p18",
		utc_job_info_add_trigger_event_p18,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p19",
		utc_job_info_add_trigger_event_p19,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p20",
		utc_job_info_add_trigger_event_p20,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_p21",
		utc_job_info_add_trigger_event_p21,
		utc_job_info_add_trigger_event_p_startup,
		utc_job_info_add_trigger_event_p_cleanup
	},
	{
		"utc_job_info_add_trigger_event_n1",
		utc_job_info_add_trigger_event_n1,
		NULL,
		NULL
	},
	{
		"utc_job_info_add_trigger_event_n2",
		utc_job_info_add_trigger_event_n2,
		utc_job_info_add_trigger_event_n2_startup,
		utc_job_info_add_trigger_event_n2_cleanup
	},
	{
		"utc_job_info_add_trigger_event_n3",
		utc_job_info_add_trigger_event_n3,
		utc_job_info_add_trigger_event_n3_startup,
		utc_job_info_add_trigger_event_n3_cleanup
	},
	{
		"utc_job_info_add_trigger_event_n4",
		utc_job_info_add_trigger_event_n4,
		utc_job_info_add_trigger_event_n4_startup,
		utc_job_info_add_trigger_event_n4_cleanup
	},
	{
		"utc_job_info_remove_trigger_event_p",
		utc_job_info_remove_trigger_event_p,
		utc_job_info_remove_trigger_event_p_startup,
		utc_job_info_remove_trigger_event_p_cleanup
	},
	{
		"utc_job_info_remove_trigger_event_n1",
		utc_job_info_remove_trigger_event_n1,
		NULL,
		NULL
	},
	{
		"utc_job_info_remove_trigger_event_n2",
		utc_job_info_remove_trigger_event_n2,
		utc_job_info_remove_trigger_event_n2_startup,
		utc_job_info_remove_trigger_event_n2_cleanup
	},
	{
		"utc_job_info_remove_trigger_event_n3",
		utc_job_info_remove_trigger_event_n3,
		utc_job_info_remove_trigger_event_n3_startup,
		utc_job_info_remove_trigger_event_n3_cleanup
	},
	{
		"utc_job_info_get_job_id_p",
		utc_job_info_get_job_id_p,
		utc_job_info_get_job_id_p_startup,
		utc_job_info_get_job_id_p_cleanup
	},
	{
		"utc_job_info_get_job_id_n1",
		utc_job_info_get_job_id_n1,
		NULL,
		NULL
	},
	{
		"utc_job_info_get_job_id_n2",
		utc_job_info_get_job_id_n2,
		utc_job_info_get_job_id_n2_startup,
		utc_job_info_get_job_id_n2_cleanup
	},
	{
		"utc_job_info_get_job_id_n3",
		utc_job_info_get_job_id_n3,
		utc_job_info_get_job_id_n3_startup,
		utc_job_info_get_job_id_n3_cleanup
	},
	{
		"utc_job_info_clone_p",
		utc_job_info_clone_p,
		utc_job_info_clone_p_startup,
		utc_job_info_clone_p_cleanup
	},
	{
		"utc_job_info_clone_n1",
		utc_job_info_clone_n1,
		NULL,
		NULL
	},
	{
		"utc_job_info_clone_n2",
		utc_job_info_clone_n2,
		utc_job_info_clone_n2_startup,
		utc_job_info_clone_n2_cleanup
	},
	{
		"utc_job_info_clone_n3",
		utc_job_info_clone_n3,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_init_p",
		utc_job_scheduler_init_p,
		NULL,
		utc_job_scheduler_init_p_cleanup
	},
	{
		"utc_job_scheduler_finish_p",
		utc_job_scheduler_finish_p,
		utc_job_scheduler_finish_p_startup,
		NULL
	},
	{
		"utc_job_scheduler_finish_n",
		utc_job_scheduler_finish_n,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_schedule_p",
		utc_job_scheduler_schedule_p,
		utc_job_scheduler_schedule_p_startup,
		utc_job_scheduler_schedule_p_cleanup
	},
	{
		"utc_job_scheduler_schedule_n1",
		utc_job_scheduler_schedule_n1,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_schedule_n2",
		utc_job_scheduler_schedule_n2,
		utc_job_scheduler_schedule_n2_startup,
		utc_job_scheduler_schedule_n2_cleanup
	},
	{
		"utc_job_scheduler_schedule_n3",
		utc_job_scheduler_schedule_n3,
		utc_job_scheduler_schedule_n3_startup,
		utc_job_scheduler_schedule_n3_cleanup
	},
	{
		"utc_job_scheduler_schedule_n4",
		utc_job_scheduler_schedule_n4,
		utc_job_scheduler_schedule_n4_startup,
		utc_job_scheduler_schedule_n4_cleanup
	},
	{
		"utc_job_scheduler_cancel_p",
		utc_job_scheduler_cancel_p,
		utc_job_scheduler_cancel_p_startup,
		utc_job_scheduler_cancel_p_cleanup
	},
	{
		"utc_job_scheduler_cancel_n1",
		utc_job_scheduler_cancel_n1,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_cancel_n2",
		utc_job_scheduler_cancel_n2,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_cancel_n3",
		utc_job_scheduler_cancel_n3,
		utc_job_scheduler_cancel_n3_startup,
		utc_job_scheduler_cancel_n3_cleanup
	},
	{
		"utc_job_scheduler_cancel_all_p",
		utc_job_scheduler_cancel_all_p,
		utc_job_scheduler_cancel_all_p_startup,
		utc_job_scheduler_cancel_all_p_cleanup
	},
	{
		"utc_job_scheduler_cancel_all_n",
		utc_job_scheduler_cancel_all_n,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_notify_job_finished_p",
		utc_job_scheduler_notify_job_finished_p,
		utc_job_scheduler_notify_job_finished_p_startup,
		utc_job_scheduler_notify_job_finished_p_cleanup
	},
	{
		"utc_job_scheduler_notify_job_finished_n1",
		utc_job_scheduler_notify_job_finished_n1,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_notify_job_finished_n2",
		utc_job_scheduler_notify_job_finished_n2,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_notify_job_finished_n3",
		utc_job_scheduler_notify_job_finished_n3,
		utc_job_scheduler_notify_job_finished_n3_startup,
		utc_job_scheduler_notify_job_finished_n3_cleanup
	},
	{
		"utc_job_scheduler_foreach_job_p",
		utc_job_scheduler_foreach_job_p,
		utc_job_scheduler_foreach_job_p_startup,
		utc_job_scheduler_foreach_job_p_cleanup
	},
	{
		"utc_job_scheduler_foreach_job_n1",
		utc_job_scheduler_foreach_job_n1,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_foreach_job_n2",
		utc_job_scheduler_foreach_job_n2,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_foreach_job_n3",
		utc_job_scheduler_foreach_job_n3,
		utc_job_scheduler_foreach_job_n3_startup,
		utc_job_scheduler_foreach_job_n3_cleanup
	},
	{
		"utc_job_scheduler_service_add_p",
		utc_job_scheduler_service_add_p,
		utc_job_scheduler_service_add_p_startup,
		utc_job_scheduler_service_add_p_cleanup
	},
	{
		"utc_job_scheduler_service_add_n1",
		utc_job_scheduler_service_add_n1,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_service_add_n2",
		utc_job_scheduler_service_add_n2,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_service_add_n3",
		utc_job_scheduler_service_add_n3,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_service_add_n4",
		utc_job_scheduler_service_add_n4,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_service_add_n5",
		utc_job_scheduler_service_add_n5,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_service_add_n6",
		utc_job_scheduler_service_add_n6,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_service_add_n7",
		utc_job_scheduler_service_add_n7,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_service_remove_p",
		utc_job_scheduler_service_remove_p,
		utc_job_scheduler_service_remove_p_startup,
		utc_job_scheduler_service_remove_p_cleanup
	},
	{
		"utc_job_scheduler_service_remove_n1",
		utc_job_scheduler_service_remove_n1,
		NULL,
		NULL
	},
	{
		"utc_job_scheduler_service_remove_n2",
		utc_job_scheduler_service_remove_n2,
		utc_job_scheduler_service_remove_n2_startup,
		utc_job_scheduler_service_remove_n2_cleanup
	},
	{
		NULL,
		NULL,
