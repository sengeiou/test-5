...
extern int utc_sticker_provider_set_group_image_p(void);
extern int utc_sticker_provider_set_group_image_n(void);
extern int utc_sticker_provider_set_group_image_n2(void);
...
extern int utc_sticker_consumer_group_image_list_foreach_all_p(void);
extern int utc_sticker_consumer_group_image_list_foreach_all_n(void);
...
testcase tc_array[] = {
    ...
    {"utc_sticker_provider_set_group_image_p", utc_sticker_provider_set_group_image_p, utc_capi_ui_sticker_provider_startup, utc_capi_ui_sticker_provider_cleanup},
    {"utc_sticker_provider_set_group_image_n", utc_sticker_provider_set_group_image_n, utc_capi_ui_sticker_provider_startup, utc_capi_ui_sticker_provider_cleanup},
    {"utc_sticker_provider_set_group_image_n2", utc_sticker_provider_set_group_image_n2, utc_capi_ui_sticker_provider_startup, utc_capi_ui_sticker_provider_cleanup},
    ...
    {"utc_sticker_consumer_group_image_list_foreach_all_p", utc_sticker_consumer_group_image_list_foreach_all_p, utc_capi_ui_sticker_consumer_startup, utc_capi_ui_sticker_consumer_cleanup},
    {"utc_sticker_consumer_group_image_list_foreach_all_n", utc_sticker_consumer_group_image_list_foreach_all_n, utc_capi_ui_sticker_consumer_startup, utc_capi_ui_sticker_consumer_cleanup},
    {NULL, NULL}
};
