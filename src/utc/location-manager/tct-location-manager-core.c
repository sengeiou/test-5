...
#ifdef MOBILE
#include "tct-location-manager-core_mobile.h"
#endif // MOBILE
#ifdef WEARABLE
#include "tct-location-manager-core_wearable.h"
#endif // WEARABLE
#ifdef TIZENIOT
#include "tct-location-manager-core_tizeniot.h"
#endif //TIZENIOT
#ifdef TV
#include "tct-location-manager-core_tv.h"
#endif // TV
