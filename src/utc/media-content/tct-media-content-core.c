...
#ifdef MOBILE
#include "tct-media-content-core_mobile.h"
#endif /* MOBILE */
#ifdef WEARABLE
#include "tct-media-content-core_wearable.h"
#endif /* WEARABLE */
#ifdef TV
#include "tct-media-content-core_tv.h"
#endif /* TV */
#ifdef TIZENIOT    
#include "tct-media-content-core_tizeniot.h"
#endif //TIZENIOT
