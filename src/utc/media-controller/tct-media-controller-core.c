...
#ifdef MOBILE
#include "tct-media-controller-core_mobile.h"
#endif /* MOBILE */
#ifdef WEARABLE
#include "tct-media-controller-core_wearable.h"
#endif /* WEARABLE */
#ifdef TV
#include "tct-media-controller-core_tv.h"
#endif /* TV */
#ifdef TIZENIOT    
#include "tct-media-controller-core_tizeniot.h"
#endif //TIZENIOT
