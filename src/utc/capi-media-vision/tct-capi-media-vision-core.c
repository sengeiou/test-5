...
#ifdef MOBILE
#include "tct-capi-media-vision-core_mobile.h"
#endif /* MOBILE */
#ifdef WEARABLE
#include "tct-capi-media-vision-core_wearable.h"
#endif /* WEARABLE */
#ifdef TV
#include "tct-capi-media-vision-core_tv.h"
#endif /* TV */
#ifdef TIZENIOT    
#include "tct-capi-media-vision-core_tizeniot.h"
#endif //TIZENIOT
