...
if [ $MODE == "inst" ]; then
	...
	chmod -R 777 $DEVICE_PHYSICAL_STORAGE_30/data
	chown -R 5001:100 $DEVICE_PHYSICAL_STORAGE_30/data

	chmod -R 777 $DEVICE_PHYSICAL_STORAGE_30/res
	chown -R 5001:100 $DEVICE_PHYSICAL_STORAGE_30/res
	
	chmod -R 777 $DEVICE_PHYSICAL_STORAGE_30/model
	chown -R 5001:100 $DEVICE_PHYSICAL_STORAGE_30/model
