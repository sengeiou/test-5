...
#ifdef MOBILE
#include "tct-voice-control-elm-core_mobile.h"
#endif

#ifdef WEARABLE
#include "tct-voice-control-elm-core_wearable.h"
#endif

#ifdef TV
#include "tct-voice-control-elm-core_tv.h"
#endif

#ifdef TIZENIOT    
#include "tct-voice-control-elm-core_tizeniot.h"
#endif //TIZENIOT
