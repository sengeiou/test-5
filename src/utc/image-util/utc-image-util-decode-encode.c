...
static bool utc_decode_completed_cb(int error, void *user_param, unsigned long width, unsigned long height, unsigned long long size)
{
...
static bool utc_encode_completed_cb(int error, void *user_param, unsigned long long size)
{
	callback_error = error;
	_signal();
	if (error == IMAGE_UTIL_ERROR_NONE)
