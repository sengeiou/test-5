...
ctsvc_tc_db_plugin_s _tc_db_contact_updated_info = {
	...
	.db_get_changes_by_version = _ctsvc_tc_db_get_chages_by_version_contact_updated_info,
	.db_get_count = NULL,
...
static int _ctsvc_tc_db_get_chages_by_version_contact_updated_info(int account_id)
{
	...
	do {
		...
		if (CONTACTS_ERROR_NONE != (ret = contacts_db_get_changes_by_version(_contacts_contact_updated_info._uri, address_book_id, version, &list, &version_new))) break;
