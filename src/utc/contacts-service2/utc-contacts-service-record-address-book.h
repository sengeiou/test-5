...
#ifndef __UTC_CONTACTS_SERVICE_RECORD_ADDRESS_BOOK_H__
#define __UTC_CONTACTS_SERVICE_RECORD_ADDRESS_BOOK_H__
...
#endif // __UTC_CONTACTS_SERVICE_RECORD_ADDRESS_BOOK_H__
