...
#ifndef __UTC_CONTACTS_SERVICE_RECORD_ACTIVITY_PHOTO_H__
#define __UTC_CONTACTS_SERVICE_RECORD_ACTIVITY_PHOTO_H__
...
#endif // __UTC_CONTACTS_SERVICE_RECORD_ACTIVITY_PHOTO_H__
