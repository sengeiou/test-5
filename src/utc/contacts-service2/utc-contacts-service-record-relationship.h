...
#ifndef __UTC_CONTACTS_SERVICE_RECORD_RELATIONSHIP_H__
#define __UTC_CONTACTS_SERVICE_RECORD_RELATIONSHIP_H__
...
#endif // __UTC_CONTACTS_SERVICE_RECORD_RELATIONSHIP_H__
