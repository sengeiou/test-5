...
ctsvc_tc_db_plugin_s _tc_db_simple_contact = {
	...
	.db_remove_changed_cb = _ctsvc_tc_db_remove_changed_cb_simple_contact,
	.db_get_record = _ctsvc_tc_db_get_record_simple_contact,
	.db_get_records_with_query = _ctsvc_tc_db_get_records_with_query_simple_contact,
	.db_get_all_records = _ctsvc_tc_db_get_all_records_simple_contact,
	.db_get_changes_by_version = NULL,
	.db_get_count = _ctsvc_tc_db_get_count_simple_contact,
	.db_get_count_with_query = _ctsvc_tc_db_get_count_with_query_simple_contact,
...
static int _ctsvc_tc_db_add_changed_cb_simple_contact(void)
{
	int ret = 0;
	do {
		if (CONTACTS_ERROR_NONE != (ret = contacts_db_add_changed_cb(_contacts_simple_contact._uri, ctsvc_tc_util_db_changed_cb, NULL))) break;
		if (CONTACTS_ERROR_NONE != (ret = contacts_db_remove_changed_cb(_contacts_simple_contact._uri, ctsvc_tc_util_db_changed_cb, NULL))) break;
		return 0;
	} while (0);
	return ret;
}
...
static int _ctsvc_tc_db_get_record_simple_contact(int account_id)
{
	...
	do {
		...
		if (CONTACTS_ERROR_NONE != (ret = contacts_db_get_record(_contacts_simple_contact._uri, id, &record))) break;
...
static int _ctsvc_tc_db_get_records_with_query_simple_contact(int account_id)
{
	...
	do {
		...
		if (CONTACTS_ERROR_NONE != (ret = contacts_query_create(_contacts_simple_contact._uri, &query))) break;
		if (CONTACTS_ERROR_NONE != (ret = contacts_filter_create(_contacts_simple_contact._uri, &filter))) break;
...
static int _ctsvc_tc_db_get_all_records_simple_contact(int account_id)
{
	...
	do {
		...
		if (CONTACTS_ERROR_NONE != (ret = contacts_db_get_all_records(_contacts_simple_contact._uri, OFFSET_DEFAULT, LIMIT_DEFAULT, &list))) break;
		if (CONTACTS_ERROR_NONE != (ret = contacts_list_get_current_record_p(list, &record_p))) break;
		if (CONTACTS_ERROR_NONE != (ret = contacts_list_destroy(list, true))) break;
		list = NULL;
...
static int _ctsvc_tc_db_get_count_simple_contact(int account_id)
{
	...
	do {
		...
		if (CONTACTS_ERROR_NONE != (ret = contacts_db_get_count(_contacts_simple_contact._uri, &count))) break;
		if (count < 1) {
			ret = -1;
			break;
		}
