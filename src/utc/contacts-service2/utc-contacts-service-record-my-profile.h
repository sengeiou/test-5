...
#ifndef __UTC_CONTACTS_SERVICE_RECORD_MY_PROFILE_H__
#define __UTC_CONTACTS_SERVICE_RECORD_MY_PROFILE_H__
...
#endif // __UTC_CONTACTS_SERVICE_RECORD_MY_PROFILE_H__
