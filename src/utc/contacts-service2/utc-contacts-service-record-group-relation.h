...
#ifndef __UTC_CONTACTS_SERVICE_RECORD_GROUP_RELATION_H__
#define __UTC_CONTACTS_SERVICE_RECORD_GROUP_RELATION_H__
...
#endif // __UTC_CONTACTS_SERVICE_RECORD_GROUP_RELATION_H__
