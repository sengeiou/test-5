...
/**
 * @function		utc_webkit2_ewk_context_form_autofill_profile_set_func_startup
...
/**
 * @function		utc_webkit2_ewk_context_form_autofill_profile_set_func_p_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_context_form_autofill_profile_set_p
 * @since_tizen		2.4
 ...
 */
int utc_webkit2_ewk_context_form_autofill_profile_set_p(void)
{
    ...
    ewk_autofill_profile_data_set(profile, EWK_PROFILE_COMPANY, newCompany);
    result = ewk_context_form_autofill_profile_set(context, TEST_AUTOFILL_PROFILE_ID, profile);
    assert_eq(result, EINA_TRUE);
    const char* companyName = ewk_autofill_profile_data_get(profile, EWK_PROFILE_COMPANY);
    assert_eq(strcmp(companyName, newCompany), 0);
    ewk_autofill_profile_delete(profile);
    return 0;
}

/**
 * @testcase		utc_webkit2_ewk_context_form_autofill_profile_set_n
 * @since_tizen		2.4
 * @description		Sets the given profile for the given id
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_context_form_autofill_profile_set_n(void)
{
    static unsigned int newID = 11234;
    Ewk_Autofill_Profile* profile = getTestEwkAutofillProfile();
    Eina_Bool result = ewk_context_form_autofill_profile_set(NULL, newID, profile);
    assert_eq(result, EINA_FALSE);
    result = ewk_context_form_autofill_profile_set(ewk_view_context_get(test_view.webview), newID, NULL);
    assert_eq(result, EINA_FALSE);
    ewk_autofill_profile_delete(profile);
    return 0;
}
