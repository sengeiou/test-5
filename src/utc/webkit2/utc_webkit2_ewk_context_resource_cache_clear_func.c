...
/**
 * @function		utc_webkit2_ewk_context_resource_cache_clear_func_startup
...
/**
 * @function		utc_webkit2_ewk_context_resource_cache_clear_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_context_resource_cache_clear_p
 * @since_tizen		2.3
 * @description		Clears HTTP caches in the local storage
 * @scenario		Call ewk_context_resource_cache_clear
 */
...
/**
 * @testcase		utc_webkit2_ewk_context_resource_cache_clear_n
 * @since_tizen		2.3
 * @description		Clears HTTP caches in the local storage
