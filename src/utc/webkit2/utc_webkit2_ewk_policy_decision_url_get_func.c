...
/**
 * @function		utc_webkit2_ewk_policy_decision_url_get_func_startup
...
/**
 * @function		utc_webkit2_ewk_policy_decision_url_get_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_policy_decision_url_get_p
 * @since_tizen		2.3
 * @description		Returns URL from policy decision object
 * @scenario		Call ewk_policy_decision_url_get in callback
 */
int utc_webkit2_ewk_policy_decision_url_get_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_policy_decision_url_get_n
 * @since_tizen		2.3
 * @description		Returns URL from policy decision object
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_policy_decision_url_get_n(void)
{
    assert_eq(ewk_policy_decision_url_get(NULL), EINA_FALSE);
    return 0;
}
