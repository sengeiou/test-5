...
/**
 * @function		utc_webkit2_ewk_cookie_manager_accept_policy_set_startup
 * @description		Called before each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_cookie_manager_accept_policy_set_startup(void)
{
    utc_webkit2_ewk_test_init();
}

/**
 * @function		utc_webkit2_ewk_cookie_manager_accept_policy_set_cleanup
 * @description		Called after each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_cookie_manager_accept_policy_set_cleanup(void)
{
    utc_webkit2_ewk_test_end();
}

/**
 * @testcase		utc_webkit2_ewk_cookie_manager_accept_policy_set_p
 * @since_tizen		2.3
 ...
 *			compare the value
 */
int utc_webkit2_ewk_cookie_manager_accept_policy_set_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_cookie_manager_accept_policy_set_n
 * @since_tizen		2.3
 * @description		Set policy\n as the cookie acceptance policy for manager
