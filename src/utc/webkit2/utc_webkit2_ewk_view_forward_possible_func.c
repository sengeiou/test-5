...
/**
 * @function		utc_webkit2_ewk_view_forward_possible_func_startup
 * @description		Called before each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_view_forward_possible_func_startup(void)
{
...
/**
 * @function		utc_webkit2_ewk_view_forward_possible_func_cleanup
 * @description		Called after each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_view_forward_possible_func_cleanup(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_view_forward_possible_p
 * @since_tizen		2.3
 ...
 */
int utc_webkit2_ewk_view_forward_possible_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_view_forward_possible_p1
 * @since_tizen		2.3
 * @description		Checks whether the main frame can navigate forward one item in history
 * @scenario        Create Webkit View\n
 *                  Set URL\n
 ...
 *                  Navigate back and Call target API
 */
int utc_webkit2_ewk_view_forward_possible_p1(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_view_forward_possible_p2
 * @since_tizen		2.3
 * @description		Checks whether the main frame can navigate forward one item in history
 * @scenario        Create Webkit View\n
 *                  Set URL\n
 ...
 *                  Navigate back and Call target API
 */
int utc_webkit2_ewk_view_forward_possible_p2(void)
{
    assert(loadURL(COMMON_SAMPLE_HTML_FILE));
    utc_webkit2_main_loop_begin();
    assert(isLoadSucceed);
...
/**
 * @testcase		utc_webkit2_ewk_view_forward_possible_n
 * @since_tizen		2.3
 * @description		Checks whether the main frame can navigate forward one item in history
 * @scenario        Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_view_forward_possible_n(void)
{
    Eina_Bool result = ewk_view_forward_possible(NULL);
    assert_eq(result, EINA_FALSE);
    return 0;
}
