...
/**
 * @function		utc_webkit2_ewk_autofill_profile_data_set_func_startup
 * @description		Called before each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_autofill_profile_data_set_func_startup(void)
{
    utc_webkit2_ewk_test_init();
}

/**
 * @function		utc_webkit2_ewk_autofill_profile_data_set_func_cleanup
 * @description		Called after each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_autofill_profile_data_set_func_cleanup(void)
{
    utc_webkit2_ewk_test_end();
}

/**
 * @testcase		utc_webkit2_ewk_autofill_profile_data_set_p
 * @since_tizen		2.4
 * @description		To Set autofill profile data
 * @scenario		ewk_autofill_profile_new\n
 *			ewk_autofill_profile_data_set\n
 *			ewk_autofill_profile_data_get\n
 *			ewk_autofill_profile_delete
 */
int utc_webkit2_ewk_autofill_profile_data_set_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_autofill_profile_data_set_n
 * @since_tizen		2.4
 * @description		To Set autofill profile data
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_autofill_profile_data_set_n(void)
{
    Ewk_Autofill_Profile* Profile = ewk_autofill_profile_new();
    assert_neq(Profile, NULL);
