...
/* Startup function */
/**
 * @function		utc_webkit2_ewk_view_back_possible_startup
 * @description		Called before each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_view_back_possible_startup(void)
{
...
/* Cleanup function */
/**
 * @function		utc_webkit2_ewk_view_back_possible_cleanup
 * @description		Called after each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_view_back_possible_cleanup(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_view_back_possible_p1
 * @since_tizen		2.3
 ...
 *                  Call target API\n
 */
int utc_webkit2_ewk_view_back_possible_p1(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_view_back_possible_p2
 * @since_tizen		2.3
 * @description     Checks whether the main frame can navigate back one item in history
 * @scenario        Create Webkit View\n
 *                  Set URL\n
 ...
 *                  Call target API\n
 */
int utc_webkit2_ewk_view_back_possible_p2(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_view_back_possible_p3
 * @since_tizen		2.3
 * @description		Checks whether the main frame can navigate back one item in history
 * @scenario        Create Webkit View\n
 *                  Set URL\n
 ...
 *                  Call target API\n
 */
int utc_webkit2_ewk_view_back_possible_p3(void)
{
    assert(loadURL(COMMON_SAMPLE_HTML_FILE));
    utc_webkit2_main_loop_begin();
...
/**
 * @testcase		utc_webkit2_ewk_view_back_possible_n
 * @since_tizen		2.3
 * @description		Checks whether the main frame can navigate back one item in history
 * @scenario        Check operation entered incorrect parameter	
 */
int utc_webkit2_ewk_view_back_possible_n(void)
{
