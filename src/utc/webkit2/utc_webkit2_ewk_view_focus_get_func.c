 ...
 * @return      NA
 */
void utc_webkit2_ewk_view_focus_get_startup(void)
{
...
/* Cleanup function */
/**
 * @function    utc_webkit2_ewk_view_focus_get_cleanup
 * @description Called after each test
 * @parameter   NA
 * @return      NA
 */
void utc_webkit2_ewk_view_focus_get_cleanup(void)
{
...
/**
 * @testcase    utc_webkit2_ewk_view_focus_get_p
 * @since_tizen 3.0
 ...
 */
int utc_webkit2_ewk_view_focus_get_p(void)
{
 ...
 *              validate the set and get values
 */
int utc_webkit2_ewk_view_focus_get_p1(void)
{
    Eina_Bool result = ewk_view_url_set(test_view.webview,
                                        COMMON_SAMPLE_HTML_FILE);
    assert_eq(result, EINA_TRUE);
...
/**
 * @testcase    utc_webkit2_ewk_view_focus_get_n
 * @since_tizen 3.0
 * @description Gets ewk view focus
 * @scenario    Check operation with incorrect parameter returns propoerly
 */
int utc_webkit2_ewk_view_focus_get_n(void)
{
    Eina_Bool focus = ewk_view_focus_get(NULL);
    assert_eq(focus, EINA_FALSE);
    return 0;
}
