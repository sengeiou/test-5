...
/**
 * @function		utc_webkit2_ewk_policy_decision_response_status_code_get_func_startup
...
/**
 * @function		utc_webkit2_ewk_policy_decision_response_status_code_get_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_policy_decision_response_status_code_get_p
 * @since_tizen		2.3
 * @description		Returns HTTP status code for response data from policy decision object
 * @scenario		Call ewk_policy_decision_response_status_code_get in callback
 */
int utc_webkit2_ewk_policy_decision_response_status_code_get_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_policy_decision_response_status_code_get_n
 * @since_tizen		2.3
 * @description		Returns HTTP status code for response data from policy decision object
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_policy_decision_response_status_code_get_n(void)
{
