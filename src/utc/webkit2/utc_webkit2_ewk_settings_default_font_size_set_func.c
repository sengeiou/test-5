...
/**
 * @function		utc_webkit2_ewk_settings_default_font_size_set_func_startup
...
/**
 * @function		utc_webkit2_ewk_settings_default_font_size_set_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_settings_default_font_size_set_p
 * @since_tizen		2.3
 ...
 */
int utc_webkit2_ewk_settings_default_font_size_set_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_settings_default_font_size_set_n
 * @since_tizen		2.3
 * @description		Sets default font size
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_settings_default_font_size_set_n(void)
{
