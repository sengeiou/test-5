...
/**
 * @function		utc_webkit2_ewk_back_forward_list_n_back_items_copy_func_startup
...
/**
 * @function		utc_webkit2_ewk_back_forward_list_n_back_items_copy_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_back_forward_list_n_back_items_copy_p
 * @since_tizen		2.3
 ...
 */
int utc_webkit2_ewk_back_forward_list_n_back_items_copy_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_back_forward_list_n_back_items_copy_n
 * @since_tizen		2.3
 * @description		Copies the BackForward list from back items
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_back_forward_list_n_back_items_copy_n(void)
{
