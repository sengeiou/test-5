...
/**
 * @function		utc_webkit2_ewk_context_cache_model_get_func_startup
...
/**
 * @function		utc_webkit2_ewk_context_cache_model_get_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_context_cache_model_get_p
 * @since_tizen		2.3
 * @description		Checking whether cache model is returned to EWK_CACHE_MODEL_DOCUMENT_VIEWER.
 * @scenario		Call ewk_context_cache_model_set to set\n
 *			Call ewk_context_cache_model_get to get the value\n
 *			Validate the get value
 */
int utc_webkit2_ewk_context_cache_model_get_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_context_cache_model_get_p1
 * @since_tizen		2.3
 * @description		Checking whether cache model is returned to EWK_CACHE_MODEL_DOCUMENT_BROWSER.
 * @scenario		Call ewk_context_cache_model_set to set\n
 *			Call ewk_context_cache_model_get to get the value\n
 *			Validate the get value
 */
int utc_webkit2_ewk_context_cache_model_get_p1(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_context_cache_model_get_p2
 * @since_tizen		2.3
 * @description		Checking whether cache model is returned to EWK_CACHE_MODEL_PRIMARY_WEBBROWSER.
 * @scenario		Call ewk_context_cache_model_set to set\n
 *			Call ewk_context_cache_model_get to get the value\n
 *			Validate the get value
 */
int utc_webkit2_ewk_context_cache_model_get_p2(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_context_cache_model_get_n
 * @since_tizen		2.3
 * @description		Checking whether function works properly in case of NULL of a context.
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_context_cache_model_get_n(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_context_cache_model_get_n1
 * @since_tizen		2.3
 * @description		Checking whether function works properly in case of NULL of a context.
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_context_cache_model_get_n1(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_context_cache_model_get_n2
 * @since_tizen		2.3
 * @description		Checking whether function works properly in case of NULL of a context.
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_context_cache_model_get_n2(void)
{
