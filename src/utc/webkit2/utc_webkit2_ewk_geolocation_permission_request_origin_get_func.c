...
/**
 * @function		utc_webkit2_ewk_geolocation_permission_request_origin_get_func_startup
 * @description		Called before each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_geolocation_permission_request_origin_get_func_startup(void)
{
...
/**
 * @function		utc_webkit2_ewk_geolocation_permission_request_origin_get_func_cleanup
 * @description		Called after each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_geolocation_permission_request_origin_get_func_cleanup(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_geolocation_permission_request_origin_get_n
 * @since_tizen		2.4
 * @description		To get geolocation permission request origin
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_geolocation_permission_request_origin_get_n(void)
{
    assert_eq(ewk_geolocation_permission_request_origin_get(NULL), NULL);
    return 0;
}
