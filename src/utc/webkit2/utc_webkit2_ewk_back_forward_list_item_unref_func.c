...
/**
 * @function		utc_webkit2_ewk_back_forward_list_item_unref_func_startup
...
/**
 * @function		utc_webkit2_ewk_back_forward_list_item_unref_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_back_forward_list_item_unref_p
 * @since_tizen		2.3
 ...
 */
int utc_webkit2_ewk_back_forward_list_item_unref_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_back_forward_list_item_unref_n
 * @since_tizen		2.3
 * @description		Decreases the reference count of the item in the BackForward list
