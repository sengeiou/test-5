...
#define SAMPLE_HTML_FILE "file:///zzxxccvv.html/"

static Eina_Bool isLoadSucceed = EINA_TRUE;
static Eina_Bool errorCode = 0;
...
static void loadError(void* data, Evas_Object* webview, void* event_info)
{
    ...
    errorCode = ewk_error_cancellation_get(ewkError);
    utc_webkit2_main_loop_quit();
    isLoadSucceed = EINA_FALSE;
}

/**
 * @function		utc_webkit2_ewk_error_cancellation_get_func_startup
 * @description		Called before each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_error_cancellation_get_func_startup(void)
{
...
/**
 * @function		utc_webkit2_ewk_error_cancellation_get_func_cleanup
 * @description		Called after each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_error_cancellation_get_func_cleanup(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_error_cancellation_get_p
 * @since_tizen		2.3
 ...
 */
int utc_webkit2_ewk_error_cancellation_get_p(void)
{
    loadURL(SAMPLE_HTML_FILE);
    assert_eq(isLoadSucceed, EINA_TRUE);
    utc_webkit2_main_loop_begin();

    assert_eq(errorCode, EINA_FALSE);
    return 0;
}

/**
 * @testcase		utc_webkit2_ewk_error_cancellation_get_n
 * @since_tizen		2.3
 * @description		Query failing URL for load error
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_error_cancellation_get_n(void)
{
    assert_eq(ewk_error_cancellation_get(NULL), EINA_FALSE);
    return 0;
}
