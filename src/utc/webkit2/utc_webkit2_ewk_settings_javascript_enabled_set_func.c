...
/**
 * @function		utc_webkit2_ewk_settings_javascript_enabled_set_func_startup
...
/**
 * @function		utc_webkit2_ewk_settings_javascript_enabled_set_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_settings_javascript_enabled_set_p
 * @since_tizen		2.3
 ...
 */
int utc_webkit2_ewk_settings_javascript_enabled_set_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_settings_javascript_enabled_set_p1
 * @since_tizen		2.3
 * @description 	Set javascript execution
 * @scenario		Set Value\n
 *			Retrieve value\n
 *			Validate the set and get values
 */
int utc_webkit2_ewk_settings_javascript_enabled_set_p1(void)
{
    Ewk_Settings* settings = ewk_view_settings_get(test_view.webview);
    assert_neq(settings, NULL);
...
/**
 * @testcase		utc_webkit2_ewk_settings_javascript_enabled_set_n
 * @since_tizen		2.3
 * @description		Set javascript execution
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_settings_javascript_enabled_set_n(void)
{
