...
/**
 * @function		utc_webkit2_ewk_policy_decision_ignore_func_startup
...
/**
 * @function		utc_webkit2_ewk_policy_decision_ignore_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_policy_decision_ignore_p
 * @since_tizen		2.3
 * @description		Ignores the action which triggers decision
 * @scenario		Call ewk_policy_decision_ignore in callback
 */
int utc_webkit2_ewk_policy_decision_ignore_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_policy_decision_ignore_n
 * @since_tizen		2.3
 * @description		Ignores the action which triggers decision
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_policy_decision_ignore_n(void)
{
