...
static Eina_Bool hasWrongURLError = EINA_FALSE;

static void loadError(void* data, Evas_Object* webview, void* error)
{
    Ewk_Error* ewkError = (Ewk_Error*)error;

    if (!strcmp(ewk_error_url_get(ewkError), URL))
        hasWrongURLError = EINA_TRUE;
...
/**
 * @function		utc_webkit2_ewk_error_url_get_func_startup
 * @description		Called before each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_error_url_get_func_startup(void)
{
...
/**
 * @function		utc_webkit2_ewk_error_url_get_func_cleanup
 * @description		Called after each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_error_url_get_func_cleanup(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_error_url_get_p
 * @since_tizen		2.3
 ...
 */
int utc_webkit2_ewk_error_url_get_p(void)
{
    Eina_Bool result = ewk_view_url_set(test_view.webview, URL);
    assert_neq(result, 0);

    utc_webkit2_main_loop_begin();
    assert_eq(hasWrongURLError, EINA_TRUE);
    return 0;
}

/**
 * @testcase		utc_webkit2_ewk_error_url_get_n
 * @since_tizen		2.3
 * @description		Query failing URL for load error
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_error_url_get_n(void)
{
