...
/**
 * @function		utc_webkit2_ewk_back_forward_list_item_at_index_get_func_startup
...
/**
 * @function		utc_webkit2_ewk_back_forward_list_item_at_index_get_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_back_forward_list_item_at_index_get_p
 * @since_tizen		2.3
 ...
 */
int utc_webkit2_ewk_back_forward_list_item_at_index_get_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_back_forward_list_item_at_index_get_n
 * @since_tizen		2.3
 * @description		Returns the item in regard to index position in the BackForward list
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_back_forward_list_item_at_index_get_n(void)
{
