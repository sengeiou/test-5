...
/**
 * @function		utc_webkit2_ewk_view_back_forward_list_clear_func_startup
...
/**
 * @function		utc_webkit2_ewk_view_back_forward_list_clear_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_view_back_forward_list_clear_p
 * @since_tizen		2.3
 ...
 */
int utc_webkit2_ewk_view_back_forward_list_clear_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_view_back_forward_list_clear_n
 * @since_tizen		2.3
 * @description		Clears the back forward list of a page]
 * @scenario        Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_view_back_forward_list_clear_n(void)
{
