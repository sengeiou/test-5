...
static const char title_expected[] = "BODY SET SUCCESS";
...
static void intercept_request_callback(Evas_Object* o, Ewk_Intercept_Request* intercept_request, void* user_data) {
  ...
  if (strcmp(url, intercept_url) == 0) {
    ...
    body_set_result = ewk_intercept_request_response_body_set(
...
/**
 * @function		utc_webkit2_ewk_intercept_request_response_body_set_func_startup
...
/**
 * @function		utc_webkit2_ewk_intercept_request_response_body_set_func_cleanup
 * @description		Called after each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_intercept_request_response_body_set_func_cleanup(void)
{
  free(body_done);
...
/**
 * @testcase		utc_webkit2_ewk_intercept_request_response_body_set_p
 * @since_tizen		3.0
...
/**
 * @testcase		utc_webkit2_ewk_intercept_request_response_body_set_n
 * @since_tizen		3.0
 * @description		Write response to intercepted request
...
/**
 * @testcase		utc_webkit2_ewk_intercept_request_response_body_set_n1
 * @since_tizen		3.0
 * @description		Write response to intercepted request
 * @scenario		Check operation for entering incorrect parameter
 */
