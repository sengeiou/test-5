...
/**
 * @function		utc_webkit2_ewk_policy_decision_type_get_func_startup
...
/**
 * @function		utc_webkit2_ewk_policy_decision_type_get_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_policy_decision_type_get_p
 * @since_tizen		2.3
 * @description		Returns a policy type from Policy Decision object
 * @scenario		Call ewk_policy_decision_type_get in callback
 */
int utc_webkit2_ewk_policy_decision_type_get_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_policy_decision_type_get_n
 * @since_tizen		2.3
 * @description		Returns a policy type from Policy Decision object
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_policy_decision_type_get_n(void)
{
