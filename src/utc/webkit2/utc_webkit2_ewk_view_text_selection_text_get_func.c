...
/**
 * @function		utc_webkit2_ewk_view_text_selection_text_get_func_startup
 * @description		Called before each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_view_text_selection_text_get_func_startup(void)
{
...
/**
 * @function		utc_webkit2_ewk_view_text_selection_text_get_func_cleanup
 * @description		Called after each test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_view_text_selection_text_get_func_cleanup(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_view_text_selection_text_get_p
 * @since_tizen		2.3
 * @description		To get the selected text
 * @scenario 		ewk_view_text_selection_text_get
 */
int utc_webkit2_ewk_view_text_selection_text_get_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_view_text_selection_text_get_n
 * @since_tizen		2.3
 * @description		To get the selected text
 * @scenario 		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_view_text_selection_text_get_n(void)
{
    const char* selectedText = ewk_view_text_selection_text_get(NULL);
    assert_eq(selectedText, NULL);
