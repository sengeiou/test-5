 ...
 * @return          NA
 */
void utc_webkit2_ewk_cookie_manager_file_scheme_cookies_allow_set_startup(void)
{
    utc_webkit2_ewk_test_init();
}

/**
 * @function        utc_webkit2_ewk_cookie_manager_file_scheme_cookies_allow_set_cleanup
 * @description     Called after each test
 * @parameter       NA
 * @return          NA
 */
void utc_webkit2_ewk_cookie_manager_file_scheme_cookies_allow_set_cleanup(void)
{
    utc_webkit2_ewk_test_end();
}

/**
 * @testcase        utc_webkit2_ewk_cookie_manager_file_scheme_cookies_allow_set_p
 * @since_tizen     3.0
 * @description     Set policy\n as the cookie acceptance policy for file scheme URLs
 * @scenario        Set policy\n
 *          Check policy in callback\n
 *          compare the value
 */
int utc_webkit2_ewk_cookie_manager_file_scheme_cookies_allow_set_p(void)
{
...
/**
 * @testcase        utc_webkit2_ewk_cookie_manager_file_scheme_cookies_allow_set_n
 * @since_tizen     3.0
 * @description     Set policy\n as the cookie acceptance policy for file scheme URLs
 * @scenario        Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_cookie_manager_file_scheme_cookies_allow_set_n(void)
{
    ewk_cookie_manager_file_scheme_cookies_allow_set(NULL, EINA_TRUE);
