...
static void intercept_request_callback(Evas_Object* o, Ewk_Intercept_Request* intercept_request, void* user_data) {
  ...
  header_map_add_result = ewk_intercept_request_response_header_map_add(intercept_request, header_map);
...
/**
 * @function		utc_webkit2_ewk_intercept_request_response_header_map_add_func_startup
...
/**
 * @function		utc_webkit2_ewk_intercept_request_response_header_map_add_func_cleanup
 * @description		Called after positive test
 * @parameter		NA
 * @return			NA
 */
void utc_webkit2_ewk_intercept_request_response_header_map_add_func_cleanup(void)
{
  free(body_done);
...
/**
 * @function		utc_webkit2_ewk_intercept_request_response_header_map_add_func_neg_startup
...
/**
 * @function		utc_webkit2_ewk_intercept_request_response_header_map_add_func_neg_cleanup
 * @description		Called after positive test
 * @parameter		NA
 * @return			NA
 */
...
/**
 * @testcase		utc_webkit2_ewk_intercept_request_response_header_map_add_p
 * @since_tizen		3.0
...
/**
 * @testcase		utc_webkit2_ewk_intercept_request_response_header_map_add_n
 * @since_tizen		3.0
 * @description		Adds headers for intercepted request response
...
/**
 * @testcase		utc_webkit2_ewk_intercept_request_response_header_map_add_n1
 * @since_tizen		3.0
 * @description		Adds headers for intercepted request response
 * @scenario		 Check operation for entering incorrect parameter
 */
