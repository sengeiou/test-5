...
/**
 * @function		utc_webkit2_ewk_back_forward_list_item_url_get_func_startup
...
/**
 * @function		utc_webkit2_ewk_back_forward_list_item_url_get_func_cleanup
...
/**
 * @testcase		utc_webkit2_ewk_back_forward_list_item_url_get_p
 * @since_tizen		2.3
 ...
 */
int utc_webkit2_ewk_back_forward_list_item_url_get_p(void)
{
...
/**
 * @testcase		utc_webkit2_ewk_back_forward_list_item_url_get_n
 * @since_tizen		2.3
 * @description		Gets the URL of the BackForward list item
 * @scenario		Check operation entered incorrect parameter
 */
int utc_webkit2_ewk_back_forward_list_item_url_get_n(void)
{
