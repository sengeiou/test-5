...
int utc_mtp_mtp_deviceinfo_get_manufacturer_name_n(void)
{
...
int utc_mtp_mtp_deviceinfo_get_model_name_n(void)
{
	int ret = MTP_ERROR_NONE;
...
int utc_mtp_mtp_deviceinfo_get_serial_number_n(void)
{
	int ret = MTP_ERROR_NONE;
...
int utc_mtp_mtp_deviceinfo_get_device_version_n(void)
{
	int ret = MTP_ERROR_NONE;
