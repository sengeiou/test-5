...
#ifdef MOBILE
#include "tct-capi-message-port-core_mobile.h"
#endif

#ifdef WEARABLE
#include "tct-capi-message-port-core_wearable.h"
#endif

#ifdef TV
#include "tct-capi-message-port-core_tv.h"
#endif

#ifdef TIZENIOT    
#include "tct-capi-message-port-core_tizeniot.h"
#endif //TIZENIOT
