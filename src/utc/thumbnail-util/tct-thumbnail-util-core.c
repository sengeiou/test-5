...
#ifdef MOBILE
#include "tct-thumbnail-util-core_mobile.h"
#endif /* MOBILE */
#ifdef WEARABLE
#include "tct-thumbnail-util-core_wearable.h"
#endif /* WEARABLE */
#ifdef TV
#include "tct-thumbnail-util-core_tv.h"
#endif /* TV */
#ifdef TIZENIOT    
#include "tct-thumbnail-util-core_tizeniot.h"
#endif //TIZENIOT
