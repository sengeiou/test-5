...
/**
 * @function            utc_Dali_EncodedBufferImage_startup
 * @description         Called before each test
 * @parameter           NA
 * @return              NA
 */
void utc_Dali_EncodedBufferImage_startup(void)
{
  test_return_value = 0;
}

/**
 * @function            utc_Dali_EncodedBufferImage_cleanup
 * @description         Called after each test
 * @parameter           NA
 * @return              NA
 */
void utc_Dali_EncodedBufferImage_cleanup(void)
{

}

void EncodedBufferImageNewWithDataDLen();
void EncodedBufferImageNewP2();
void EncodedBufferImageDownCast();
void EncodedBufferImageDefaultConstructor();
void EncodedBufferImageCopyConstructor();
void EncodedBufferImageOperatorAssignment();
...
namespace
{
  enum TEST_CASES_LIST_ENCODED_BUFFER_IMAGE
  {
    ...
    ENCODED_BUFFER_IMAGE_NEW_P2,
    ENCODED_BUFFER_IMAGE_DOWNCAST,
    ENCODED_BUFFER_DEFAULT_CONSTRUCTOR,
    ENCODED_BUFFER_COPY_CONSTRUCTOR,
    ENCODED_BUFFER_ASSIGNMENT_OPERATOR
  };
  ...
  struct Encoded_Buffer_Image_TestApp : public ConnectionTracker
  {
    ...
    void ExcuteTest()
    {
      switch (mTestCase)
      {
        ...
        case ENCODED_BUFFER_IMAGE_NEW_P2:
          EncodedBufferImageNewP2();
          break;
        ...
        case ENCODED_BUFFER_DEFAULT_CONSTRUCTOR:
          EncodedBufferImageDefaultConstructor();
          break;

        case ENCODED_BUFFER_COPY_CONSTRUCTOR:
          EncodedBufferImageCopyConstructor();
          break;

        case ENCODED_BUFFER_ASSIGNMENT_OPERATOR:
          EncodedBufferImageOperatorAssignment();
          break;
      }
    }
...
void EncodedBufferImageNewWithDataDLen()
{
  Image image = EncodedBufferImage::New(sEncodedBufferImageDataPNG, LENGTH_OF_ENCODED_BUFFER_IMG_PNG_DATA);
  DALI_CHECK_FAIL( !image ,  "EncodedBufferImage::New is failed ");
...
void EncodedBufferImageNewP2()
{
  ...
  Image image = EncodedBufferImage::New(sEncodedBufferImageDataPNG, LENGTH_OF_ENCODED_BUFFER_IMG_PNG_DATA, size, FittingMode::DEFAULT, SamplingMode::DEFAULT, true);
  DALI_CHECK_FAIL( !image ,  "EncodedBufferImage::New is failed ");
...
/**********************************
  End of Logic Implementation Area
 ***********************************/

/**
 * @testcase            UtcDaliEncodedBufferImageDefaultConstructorP
 * @since_tizen         2.4
 * @description         check if the default constructor works or not.
 */

int UtcDaliEncodedBufferImageDefaultConstructorP(void)
{
  DaliLog::PrintExecStarted(SUITE_NAME, __FUNCTION__);
  Application application = Application::New( &gArgc, &gArgv );
  CHECK_GL;
  Encoded_Buffer_Image_TestApp testApp( application, ENCODED_BUFFER_DEFAULT_CONSTRUCTOR);
...
/**
 * @testcase            UtcDaliEncodedBufferImageCopyConstructorP
 * @since_tizen         2.4
 * @description         check if the copy constructor works or not.
 */

int UtcDaliEncodedBufferImageCopyConstructorP(void)
{
  DaliLog::PrintExecStarted(SUITE_NAME, __FUNCTION__);
  Application application = Application::New( &gArgc, &gArgv );
  CHECK_GL;
  Encoded_Buffer_Image_TestApp testApp( application, ENCODED_BUFFER_COPY_CONSTRUCTOR);
  application.MainLoop();
  return test_return_value;
}
...
/**
 * @testcase            UtcDaliEncodedBufferImageAssignmentOperatorP
 * @since_tizen         2.4
 * @description         check if the operator=() works or not.
 */
...
int UtcDaliEncodedBufferImageOperatorAssignmentP(void)
{
  ...
  Application application = Application::New( &gArgc, &gArgv );
  CHECK_GL;
  Encoded_Buffer_Image_TestApp testApp( application, ENCODED_BUFFER_ASSIGNMENT_OPERATOR);
  application.MainLoop();
  return test_return_value;
}
...
/**
 * @testcase            UtcDaliEncodedBufferImageNewP
 * @since_tizen         2.4
 * @description         check if the New api works or not.
 */

int UtcDaliEncodedBufferImageNewP(void)
{
  DaliLog::PrintExecStarted(SUITE_NAME, __FUNCTION__);
  Application application = Application::New( &gArgc, &gArgv );
  CHECK_GL;
...
/**
 * @testcase            UtcDaliEncodedBufferImageNewP2
 * @since_tizen         2.4
 * @description         check if the New api works or not.
 */
...
int UtcDaliEncodedBufferImageNewP2(void)
{
  ...
  Application application = Application::New( &gArgc, &gArgv );
  CHECK_GL;
  Encoded_Buffer_Image_TestApp testApp( application, ENCODED_BUFFER_IMAGE_NEW_P2);
  application.MainLoop();
  return test_return_value;
}
...
/**
 * @testcase            UtcDaliEncodedBufferImageDownCastP
 * @since_tizen         2.4
 * @description         check if the DownCast api works or not.
 */
