...
//& set: utc-download-unset-state-changed-cb
...
void utc_url_download_unset_state_changed_cb_startup(void)
{
	int retcode = 0;
...
void utc_url_download_unset_state_changed_cb_cleanup(void)
{
	int retcode = 0;
...
/**
 * @testcase		utc_url_download_unset_state_changed_cb_p1
 * @since_tizen		2.3
 * @description		Positive test case of download_unset_state_changed_cb()
 */
int utc_url_download_unset_state_changed_cb_p1(void)
{
    int retcode = 0;
...
/**
 * @testcase		utc_url_download_unset_state_changed_cb_n1
 * @since_tizen		2.3
 * @description		Negative test case of download_unset_state_changed_cb() - Invalid parameter(ID)
 */
int utc_url_download_unset_state_changed_cb_n1(void)
{
    int retcode = 0;
