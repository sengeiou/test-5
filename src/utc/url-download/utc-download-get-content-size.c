...
/**
 * @function		utc_download_get_content_size_startup
...
/**
 * @function		utc_download_get_content_size_cleanup
...
/**
 * @testcase		utc_download_get_content_size_p1
 * @since_tizen		2.3
 * @description		Positive test case of download_get_content_size()
 */
int utc_download_get_content_size_p1(void)
{
    int retcode = 0;
...
/**
 * @testcase		utc_download_get_content_size_n1
 * @since_tizen		2.3
 * @description		Negative test case of download_get_content_size() - Invalid parameter(ID)
 */
int utc_download_get_content_size_n1(void)
{
    int retcode = 0;
    unsigned long long output = 0;
...
/**
 * @testcase		utc_download_get_content_size_n2
 * @since_tizen		2.3
 * @description		Negative test case of download_get_content_size() - Invalid parameter(NULL pointer)
 */
