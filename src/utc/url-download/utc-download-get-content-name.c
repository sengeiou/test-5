...
/**
 * @function		utc_download_get_content_name_startup
...
/**
 * @function		utc_download_get_content_name_cleanup
...
/**
 * @testcase		utc_download_get_content_name_p1
 * @since_tizen		2.3
 * @description		Positive test case of download_get_content_name()
 */
int utc_download_get_content_name_p1(void)
{
    int retcode = 0;
    char *output = NULL;
...
/**
 * @testcase		utc_download_get_content_name_n1
 * @since_tizen		2.3
 * @description		Negative test case of download_get_content_name() - Invalid parameter(ID)
 */
int utc_download_get_content_name_n1(void)
{
    int retcode = 0;
    char *output = NULL;
...
/**
 * @testcase		utc_download_get_content_name_n2
 * @since_tizen		2.3
 * @description		Negative test case of download_get_content_name() - Invalid parameter(NULL pointer)
 */
