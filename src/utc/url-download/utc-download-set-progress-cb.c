...
//& set: utc-download-set-progress-cb
...
void utc_download_set_progress_cb_startup(void)
{
	int retcode = 0;
...
void utc_download_set_progress_cb_cleanup(void)
{
...
/**
 * @testcase		utc_download_set_progress_cb_p1
 * @since_tizen		2.3
 * @description		Positive test case of download_set_progress_cb()
 */
int utc_download_set_progress_cb_p1(void)
{
    int retcode = 0;
...
/**
 * @testcase		utc_download_set_progress_cb_n1
 * @since_tizen		2.3
 * @description		Negative test case of download_set_progress_cb() - Invalid parameter(ID)
 */
int utc_download_set_progress_cb_n1(void)
{
    int retcode = 0;
