...
/**
 * @function		utc_download_get_etag_startup
...
/**
 * @function		utc_download_get_etag_cleanup
...
/**
 * @testcase		utc_download_get_etag_p1
 * @since_tizen		2.3
 * @description		Positive test case of download_get_etag()
 */
int utc_download_get_etag_p1(void)
{
    int retcode = 0;
    char *etag = NULL;
...
/**
 * @testcase		utc_download_get_etag_n1
 * @since_tizen		2.3
 * @description		Negative test case of download_get_etag() - Invalid parameter(ID)
 */
int utc_download_get_etag_n1(void)
{
    int retcode = 0;
    char *etag = NULL;
...
/**
 * @testcase		utc_download_get_etag_n2
 * @since_tizen		2.3
 * @description		Negative test case of download_get_etag() - Invalid parameter(NULL pointer)
 */
