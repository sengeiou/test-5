...
/**
 * @testcase		utc_package_manager_package_info_is_removable_package_p
 * @since_tizen		2.3
 * @description		Positive test case of package_info_is_removable_package()
 */
...
/**
 * @testcase		utc_package_manager_package_info_is_removable_package_n
 * @since_tizen		2.3
 * @description		Negative test case of package_info_is_removable_package()
 */
