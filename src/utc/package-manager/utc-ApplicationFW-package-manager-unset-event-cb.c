...
/**
 * @testcase		utc_ApplicationFW_package_manager_unset_event_cb_p
 * @since_tizen		2.3
 * @description		Test unregister callback function from callback function list
 *					which will be invoked when package event has broadcasted.
 */
...
/**
 * @testcase		utc_ApplicationFW_package_manager_unset_event_cb_n
 * @since_tizen		2.3
 * @description		Test failed to remove callback from list by passing
