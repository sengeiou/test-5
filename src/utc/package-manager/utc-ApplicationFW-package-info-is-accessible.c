...
/**
 * @testcase		utc_package_managerpackage_info_is_accessible_p
 * @since_tizen		2.3
 * @description		Positive test case of package_info_is_accessible()
 */
...
/**
 * @testcase		utc_package_managerpackage_info_is_accessible_n
 * @since_tizen		2.3
 * @description		Negative test case of package_info_is_accessible()
 */
