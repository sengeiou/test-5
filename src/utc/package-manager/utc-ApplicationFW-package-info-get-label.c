...
/**
 * @testcase		utc_package_manager_package_info_get_label_p
 * @since_tizen		2.3
 * @description		Positive test case of package_info_get_label()
 */
...
/**
 * @testcase		utc_package_manager_package_info_get_label_n
 * @since_tizen		2.3
 * @description		Negative test case of package_info_get_label()
 */
