...
/**
 * @testcase		utc_package_manager_package_info_get_root_path_p
 * @since_tizen		2.3
 * @description		Positive test case of package_info_get_root_path()
 */
...
/**
 * @testcase		utc_package_manager_package_info_get_root_path_n
 * @since_tizen		2.3
 * @description		Negative test case of package_info_get_root_path()
 */
