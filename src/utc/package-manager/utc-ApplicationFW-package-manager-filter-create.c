...
/**
 * @testcase		utc_package_manager_package_manager_filter_create_p
 * @since_tizen		2.3
 * @description		Test creates package manager filter.
 */
...
/**
 * @testcase		utc_package_manager_package_manager_filter_create_n
 * @since_tizen		2.3
 * @description		Test failed to create package manager filter by passing NULL as argument.
 */
