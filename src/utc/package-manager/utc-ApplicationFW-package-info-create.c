...
/**
 * @testcase		utc_ApplicationFW_package_info_create_p
 * @since_tizen		2.3
 * @description		Positive test case of package_info_create()
 */
...
/**
 * @testcase		utc_ApplicationFW_package_info_create_n1
 * @since_tizen		2.3
 * @description		Negative test case of package_info_create()
 */
int utc_ApplicationFW_package_info_create_n1(void)
{
	int ret = PACKAGE_MANAGER_ERROR_NONE;
	package_info_h package_info = NULL;
...
/**
 * @testcase		utc_ApplicationFW_package_info_create_n2
 * @since_tizen		2.3
 * @description		Negative test case of package_info_create()
 */
int utc_ApplicationFW_package_info_create_n2(void)
{
	int ret = PACKAGE_MANAGER_ERROR_NONE;
	package_info_h package_info = NULL;
