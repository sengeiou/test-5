 ...
 * @since_tizen		3.0
 * @description		Positive UTC for starting TTS engine
 */
 ...
 * @since_tizen		3.0
 * @description		Negative UTC for starting TTS engine
 */
...
/**
 * @testcase		utc_ttse_terminate_p
 * @since_tizen		7.0
 * @description		Positive UTC for terminating TTS engine
 */
int utc_ttse_terminate_p(void)
{
	int ret = TTSE_ERROR_NONE;
	...
	dlog_print(DLOG_INFO, "NativeTCT", "[utc_ttse_terminate_p] ttse_main SUCCESS");
...
/**
 * @testcase		utc_ttse_terminate_n
 * @since_tizen		7.0
 * @description		Negative UTC for terminating TTS engine
 */
int utc_ttse_terminate_n(void)
{
	int ret = TTSE_ERROR_NONE;
	ret = ttse_terminate();
	assert_eq(ret, TTSE_ERROR_OPERATION_FAILED);
