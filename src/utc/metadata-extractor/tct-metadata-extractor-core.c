...
#ifdef MOBILE
#include "tct-metadata-extractor-core_mobile.h"
#endif /* MOBILE */
#ifdef WEARABLE
#include "tct-metadata-extractor-core_wearable.h"
#endif /* WEARABLE */
#ifdef TV
#include "tct-metadata-extractor-core_tv.h"
#endif /* TV */
#ifdef TIZENIOT    
#include "tct-metadata-extractor-core_tizeniot.h"
#endif //TIZENIOT
