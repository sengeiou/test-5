...
#ifdef MOBILE
#include "tct-appcore-agent-core_mobile.h"
#endif

#ifdef WEARABLE
#include "tct-appcore-agent-core_wearable.h"
#endif

#ifdef TV
#include "tct-appcore-agent-core_tv.h"
#endif

#ifdef TIZENIOT    //Starts TIZENIOT
#include "tct-appcore-agent-core_tizeniot.h"
...
static int check_func_name(int argc, char **argv)
{
	...
	if (argc > 2) {
		...
		g_free(org);
		if (pszGetTCName) {
			if (!strcmp(pszGetTCName, "utc_appcore_agent_service_app_main_p1")
					|| !strcmp(pszGetTCName, "utc_appcore_agent_service_app_main_p2")
					|| !strcmp(pszGetTCName, "utc_appcore_agent_service_app_main_n1")
					|| !strcmp(pszGetTCName, "utc_appcore_agent_service_app_main_n2")
					|| !strcmp(pszGetTCName, "utc_appcore_agent_service_app_main_n3")
					|| !strcmp(pszGetTCName, "utc_appcore_agent_service_app_exit_p")) {
				return 1;
			}
		}
	}
