...
#ifdef MOBILE
#include "tct-capi-media-streamer-core_mobile.h"
#endif /* MOBILE */
#ifdef WEARABLE
#include "tct-capi-media-streamer-core_wearable.h"
#endif /* WEARABLE */
#ifdef TV
#include "tct-capi-media-streamer-core_tv.h"
#endif /* TV */
#ifdef TIZENIOT    
#include "tct-capi-media-streamer-core_tizeniot.h"
#endif //TIZENIOT
