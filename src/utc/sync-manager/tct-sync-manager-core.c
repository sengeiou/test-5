...
#ifdef MOBILE
#include "tct-sync-manager-core_mobile.h"
#endif // MOBILE
#ifdef WEARABLE
#include "tct-sync-manager-core_wearable.h"
#endif // WEARABLE
#ifdef TIZENIOT
#include "tct-sync-manager-core_tizeniot.h"
#endif // TIZENIOT
#ifdef TV
#include "tct-sync-manager-core_tv.h"
#endif // TV
