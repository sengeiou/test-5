%define MODULE_NAME accounts-svc
%define MODULE_LIBNAME accounts-svc
...
cp src/utc/accounts-svc/account.png %{buildroot}/usr/apps/%{name}/shared/res
cp src/utc/accounts-svc/account_small.png %{buildroot}/usr/apps/%{name}/shared/res
