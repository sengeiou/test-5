...
cp src/utc/contacts-service2/account.png %{buildroot}/usr/apps/%{name}/shared/res
cp src/utc/contacts-service2/account_small.png %{buildroot}/usr/apps/%{name}/shared/res
%post
