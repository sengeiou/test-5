%define MODULE_NAME nnstreamer
%define MODULE_LIBNAME nnstreamer
Name:       native-%{MODULE_NAME}-itc
Summary:    Native API Integration Test (%{name})
Version:    0.1
Release:    0
...
BuildRequires:	cmake
BuildRequires:	pkgconfig(nnstreamer-capi)
BuildRequires:	pkgconfig(dlog)
%description
Native API Integration Test (%{name})
