%define MODULE_NAME nsd
%define MODULE_LIBNAME_SSDP nsd-ssdp
%define MODULE_LIBNAME_DNS_SD nsd-dns-sd
...
BuildRequires:	pkgconfig(%{MODULE_LIBNAME_DNS_SD})
BuildRequires:	pkgconfig(%{MODULE_LIBNAME_SSDP})
