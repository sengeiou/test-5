%define MODULE_NAME contacts-service2
%define MODULE_LIBNAME contacts-service2
...
cp src/itc/contacts-service2/TestRingtone.mp3 %{buildroot}%{APP_PATH}%{name}/data/TestRingtone.mp3
cp src/itc/contacts-service2/icon.png %{buildroot}%{APP_PATH}%{name}/data/icon.png
