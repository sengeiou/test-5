%define MODULE_NAME watchface-complication
%define MODULE_LIBNAME watchface-complication
...
cp -r src/itc/watchface-complication/res/* %{buildroot}%{APP_PATH}%{name}/res
