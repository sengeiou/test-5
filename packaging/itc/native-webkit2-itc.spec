...
mkdir -p %{buildroot}%{APP_PATH}%{name}/data/webkit2_files/res
mkdir -p %{buildroot}%{APP_PATH}%{name}/data/webkit2_files/res/common
mkdir -p %{buildroot}%{APP_PATH}%{name}/data/webkit2_files/res/ewk_context
mkdir -p %{buildroot}%{APP_PATH}%{name}/data/webkit2_files/res/ewk_context_menu
mkdir -p %{buildroot}%{APP_PATH}%{name}/data/webkit2_files/res/ewk_view
cp src/itc/webkit2/res/common/* %{buildroot}%{APP_PATH}%{name}/data/webkit2_files/res/common/
cp src/itc/webkit2/res/ewk_context_menu/* %{buildroot}%{APP_PATH}%{name}/data/webkit2_files/res/ewk_context_menu/
cp src/itc/webkit2/res/ewk_context/* %{buildroot}%{APP_PATH}%{name}/data/webkit2_files/res/ewk_context/
cp src/itc/webkit2/res/ewk_view/* %{buildroot}%{APP_PATH}%{name}/data/webkit2_files/res/ewk_view/
