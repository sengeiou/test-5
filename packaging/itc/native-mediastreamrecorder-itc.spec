%define MODULE_NAME mediastreamrecorder
%define MODULE_LIBNAME capi-media-streamrecorder
...
cp src/itc/mediastreamrecorder/short.mp3 %{buildroot}%{APP_PATH}%{name}/data/short.mp3
cp src/itc/mediastreamrecorder/I420_352x288.yuv %{buildroot}%{APP_PATH}%{name}/data/I420_352x288.yuv
